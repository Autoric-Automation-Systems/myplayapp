    ...
    return (
        <>
            ...
            >
                ...
                <div className="w-10 sm:w-12 text-center text-white/70 text-[11px] sm:text-sm">{track.key}</div>
                <div className="w-12 sm:w-14 text-center text-white/70 text-[11px] sm:text-sm">{track.bpm}</div>
                <div className="w-14 text-center hidden md:block text-white/70 text-sm truncate">{track.style}</div>
                {/* Ações */}
